...
def process_file(model, path_out, compress=True, target_res=0.7, source_res=0.3,
    ...
    if nimg is not None:
        ...
        result = inference_model(model, nimg,
                                 ...
                                 scale=2, batch_size=batch_size, manager=manager, add_noise=None) # you can add noise during inference to get smoother results (try from 0.1 to 0.3; the higher the smoother effect!) 
